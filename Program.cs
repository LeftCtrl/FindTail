...
namespace FindTail
{
  class Program
  {
    ...
    /// 4) Начиная с нулевого индекса, параллельно итерируемся по массиву методом перехода к индексу сразу двумя итераторами, отстающих друг от друга на длину "петли". 
